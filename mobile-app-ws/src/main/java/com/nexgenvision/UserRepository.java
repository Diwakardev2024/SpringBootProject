...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
	...
	@Query(value="select * from Users u where u.EMAILVERIFICATION_STATUS='true'",
	countQuery="select count(*)from Users u where u.EMAILVERIFICATION_STATUS='true'",nativeQuery=true)
